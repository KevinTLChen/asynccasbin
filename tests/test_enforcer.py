...
class TestCaseBase(IsolatedAsyncioTestCase):
    async def get_enforcer(self, model=None, adapter=None):
        ...
        return await casbin.Enforcer.create(
            model,
            adapter,
        )
...
class TestConfig(TestCaseBase):
    ...
    async def test_enforce_basic_with_root(self):
        e = await self.get_enforcer(get_examples("basic_with_root_model.conf"), get_examples("basic_policy.csv"))
    ...
    async def test_enforce_ip_match(self):
        e = await self.get_enforcer(get_examples("ipmatch_model.conf"), get_examples("ipmatch_policy.csv"))
    ...
    async def test_enforce_key_match(self):
        e = await self.get_enforcer(get_examples("keymatch_model.conf"), get_examples("keymatch_policy.csv"))
    ...
    async def test_enforce_key_match2(self):
        e = await self.get_enforcer(get_examples("keymatch2_model.conf"), get_examples("keymatch2_policy.csv"))
    ...
    async def test_enforce_priority(self):
        e = await self.get_enforcer(get_examples("priority_model.conf"), get_examples("priority_policy.csv"))
        self.assertTrue(e.enforce("alice", "data1", "read"))
        self.assertFalse(e.enforce("alice", "data1", "write"))
        self.assertFalse(e.enforce("alice", "data2", "read"))
        self.assertFalse(e.enforce("alice", "data2", "write"))
    ...
    async def test_enforce_rbac_empty_policy(self):
        e = await self.get_enforcer(get_examples("rbac_model.conf"), get_examples("empty_policy.csv"))
        self.assertFalse(e.enforce("alice", "data1", "read"))
        self.assertFalse(e.enforce("bob", "data1", "read"))
        self.assertFalse(e.enforce("bob", "data2", "write"))
        self.assertFalse(e.enforce("alice", "data2", "read"))
    ...
    async def test_abac_with_sub_rule(self):
        e = await self.get_enforcer(get_examples("abac_rule_model.conf"), get_examples("abac_rule_policy.csv"))
    ...
    async def test_temporal_roles_model(self):
        e = await self.get_enforcer(
    ...
    async def test_temporal_roles_model_with_domain(self):
        e = await self.get_enforcer(
    ...
    async def test_link_condition_function(self):
        e = await self.get_enforcer(
            get_examples("rbac_with_temporal_roles_model.conf"),
